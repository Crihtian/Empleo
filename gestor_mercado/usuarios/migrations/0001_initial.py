    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('GESTOR', 'Gestor de Proyectos'), ('COLAB', 'Colaborador')], default='COLAB', max_length=10)),
            ...
            options={
                'indexes': [models.Index(fields=['role'], name='usuarios_us_role_95c5cd_idx'), models.Index(fields=['date_joined'], name='usuarios_us_date_jo_26f14d_idx')],
            },
            managers=[
